...
public class Test implements Assessment {
	...
	public void assign(float wt) throws InvalidWeightException
	{
		...
		if (wt < 0)
		{
			throw new InvalidWeightException("Error: Test.weight cannot be negatve!");
		}
		if (wt > 100)
		{
			throw new InvalidWeightException("Error: Test.weight cannot be larger than 100%!");
	...
	public void mark(float gr) throws InvalidGradeException
	{
		...
		if (gr < 0)
		{
			throw new InvalidGradeException("Error: Test.grade cannot be negative!");
		}
		else if (gr > 100)
		{
			// Accept bonus marks?
			throw new InvalidGradeException("Error: Test.grade cannot be larger than 100%!");
		}
